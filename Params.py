...
def ParseArgs():
	...
	parser.add_argument('--data', default='Toys', type=str, help='name of dataset')
	...
	parser.add_argument('--ris_lambda', type=float, default=0.1)
	parser.add_argument('--ris_adj_lambda', type=float, default=0.2)
	parser.add_argument('--trans', type=int, default=1, help='0: R*R, 1: Linear, 2: allrecipes')
	parser.add_argument('--cl_method', type=int, default=0, help='0:m vs m ; 1:m vs main')


	parser.add_argument('--self_loop_val', type=float, default=0.47, help='value for self loop')
	parser.add_argument('--sentiment_offset', type=float, default=0.1, help='offset value for sentiment score padding')
